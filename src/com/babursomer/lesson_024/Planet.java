package com.babursomer.lesson_024;
...
public enum Planet {
	...
	public static void main(String[] args) {
		BAUtils.header("U Z A Y   K İ L O N U Z");
		
		double earthWeight = BAUtils.readDouble("Dünyadaki ağırlığınızı giriniz");
		double mass = earthWeight / EARTH.surfaceGravity();
		
		for (Planet p : Planet.values()) {
			System.out.printf("\t%s'teki ağırlığınız %.2fkg\n", p.getName(), p.surfaceWeight(mass));
		}
