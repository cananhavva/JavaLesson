...
public class Fibonacci {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"\n" + n + "\'ncu Fibonacci sayısı " + fib + " hesaplanması " + (stop - start) + " nano saniye sürdü");
		
		start = System.nanoTime();
		fib = (long) calcFibonacciExplicit(n);
		stop = System.nanoTime();
		System.out.println("\n" + n + "\'ncu Fibonacci sayısı " + fib + " hesaplanması matematiksel formül kullanarak "
				+ (stop - start) + " nano saniye sürdü");
		
		start = System.nanoTime();
		fib = calcFibonacciRecursive(n);
		stop = System.nanoTime();
		System.out.println("\n" + n + "\'ncu Fibonacci sayısı " + fib + " hesaplanması özyinenemeli olarak "
				+ (stop - start) + " nano saniye sürdü");
