...
public class Factorial {
	...
	public static void main(String[] args) {
		...
		System.out.println(n + " sayısının faktöriyeli " + fact + " " + (stop - start) + " nano saniyede hesaplandı");
		
		start = System.nanoTime();
		fact = calcFactorielRecursive(n);
		stop = System.nanoTime();
		System.out.println(n + " sayısının faktöriyeli " + fact + " " + (stop - start)
				+ " nano saniyede özyenilemeli olarak hesaplandı");
