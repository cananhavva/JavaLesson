...
public class Globalization {
	...
	public static void main(String[] args) {
		...
		// 100.0TL değerindeki malın %18 KDV ile değeri 118.0TL'dir
		// $1$$4$ değerindeki mal\u0131n %$2$ KDV ile değeri $3$$4$'dir
		
		msg = msg.replace("$1$", "" + price);
		// 100.0$4$ de\u011Ferindeki mal\u0131n %$2$ KDV ile değeri $3$$4$'dir
		msg = msg.replace("$4$", globalization.getString("Globalization.MONEY_SIGN"));
		// 100.0TL değerindeki mal\u0131n %$2$ KDV ile değeri $3$TL'dir
		...
		// 100.0TL değerindeki mal\u0131n %18 KDV ile değeri $3$TL'dir
